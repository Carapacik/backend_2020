...
-- TIMESTAMP хранит число секунд от полуночи 1 января 1970 года по усреднённому времени Гринвича, используя 4 байта
-- TIMESTAMP при получении из базы отображается с учётом часового пояса
-- DATETIME не зависит от часового пояса
-- TIMESTAMP по умолчанию хранит значение NOW
